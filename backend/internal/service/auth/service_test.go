...
func truncateAuthState(t *testing.T, g *gorm.DB) {
	...
	for _, stmt := range []string{
		`TRUNCATE TABLE ai_messages, ai_threads, ingestion_jobs, positions, prices, savings_goals, budgets, transactions, account_shares, accounts, household_invites, household_members, households, sessions, instance_config, users RESTART IDENTITY CASCADE`,
	} {
